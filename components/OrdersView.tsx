    ...
    <div className="space-y-6 animate-in fade-in duration-300 relative h-full flex flex-col">
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-400 bg-slate-50 border border-slate-100 rounded-xl cursor-not-allowed">
